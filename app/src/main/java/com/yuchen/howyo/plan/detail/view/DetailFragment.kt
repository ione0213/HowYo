...
class DetailFragment : Fragment(), OnMapReadyCallback {
    ...
    private val viewModel by viewModels<DetailViewModel> {
        getVmFactory(
            com.yuchen.howyo.plan.detail.DetailFragmentArgs.fromBundle(requireArguments()).schedule
        )
    }
...
//            (childFragmentManager.findFragmentById(com.yuchen.howyo.R.id.map) as SupportMapFragment?).getMap()
